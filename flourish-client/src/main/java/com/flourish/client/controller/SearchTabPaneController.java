...
import com.flourish.client.model.*;
import com.flourish.client.service.ServerConnection;
import com.flourish.client.view.AutocompleteSearchField;
import com.flourish.client.view.MessageBox;
import com.flourish.client.view.PopupBox;
import com.flourish.client.view.SearchPlantPane;
...
public class SearchTabPaneController {
    ...
    public void initialize() {
        ...
        imgUserAvatar.setFill(new ImagePattern(new Image(
                SetAvatar.setAvatarOnLogin(loggedInUser.getUser().getEmail()))));
